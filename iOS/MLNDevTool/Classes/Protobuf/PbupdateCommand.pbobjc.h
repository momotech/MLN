 ...
 **/
@interface PbupdateCommandRoot : GPBRootObject
@end

#pragma mark - pbupdatecommand

typedef GPB_ENUM(pbupdatecommand_FieldNumber) {
  pbupdatecommand_FieldNumber_Basecommand = 1,
  pbupdatecommand_FieldNumber_FilePath = 2,
  pbupdatecommand_FieldNumber_RelativeFilePath = 3,
  pbupdatecommand_FieldNumber_FileData = 4,
};

@interface pbupdatecommand : GPBMessage
