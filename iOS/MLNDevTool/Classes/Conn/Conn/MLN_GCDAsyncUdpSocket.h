...
extern NSString *const MLN_GCDAsyncUdpSocketException;
extern NSString *const MLN_GCDAsyncUdpSocketErrorDomain;

extern NSString *const MLN_GCDAsyncUdpSocketQueueName;
extern NSString *const MLN_GCDAsyncUdpSocketThreadName;

typedef NS_ENUM(NSInteger, MLN_GCDAsyncUdpSocketError) {
	MLN_GCDAsyncUdpSocketNoError = 0,          // Never used
	MLN_GCDAsyncUdpSocketBadConfigError,       // Invalid configuration
	MLN_GCDAsyncUdpSocketBadParamError,        // Invalid parameter was passed
	MLN_GCDAsyncUdpSocketSendTimeoutError,     // A send operation timed out
	MLN_GCDAsyncUdpSocketClosedError,          // The socket was closed
	MLN_GCDAsyncUdpSocketOtherError,           // Description provided in userInfo
};
...
@class MLN_GCDAsyncUdpSocket;

@protocol MLN_GCDAsyncUdpSocketDelegate <NSObject>
@optional
...
**/
- (void)udpSocket:(MLN_GCDAsyncUdpSocket *)sock didConnectToAddress:(NSData *)address;
...
**/
- (void)udpSocket:(MLN_GCDAsyncUdpSocket *)sock didNotConnect:(NSError * _Nullable)error;

/**
 * Called when the datagram with the given tag has been sent.
**/
- (void)udpSocket:(MLN_GCDAsyncUdpSocket *)sock didSendDataWithTag:(long)tag;

/**
 * Called if an error occurs while trying to send a datagram.
 * This could be due to a timeout, or something more serious such as the data being too large to fit in a sigle packet.
**/
- (void)udpSocket:(MLN_GCDAsyncUdpSocket *)sock didNotSendDataWithTag:(long)tag dueToError:(NSError * _Nullable)error;

/**
 * Called when the socket has received the requested datagram.
**/
- (void)udpSocket:(MLN_GCDAsyncUdpSocket *)sock didReceiveData:(NSData *)data
...
**/
- (void)udpSocketDidClose:(MLN_GCDAsyncUdpSocket *)sock withError:(NSError  * _Nullable)error;
 ...
 * Example:
 * 
 * MLN_GCDAsyncUdpSocketReceiveFilterBlock filter = ^BOOL (NSData *data, NSData *address, id *context) {
 * 
 ...
 * 
**/
typedef BOOL (^MLN_GCDAsyncUdpSocketReceiveFilterBlock)(NSData *data, NSData *address, id __nullable * __nonnull context);
 ...
 *
**/
typedef BOOL (^MLN_GCDAsyncUdpSocketSendFilterBlock)(NSData *data, NSData *address, long tag);


@interface MLN_GCDAsyncUdpSocket : NSObject

/**
 * MLN_GCDAsyncUdpSocket uses the standard delegate paradigm,
 ...
 * If you pass NULL, MLN_GCDAsyncSocket will automatically create its own socket queue.
...
- (instancetype)initWithDelegate:(nullable id <MLN_GCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq;
- (instancetype)initWithDelegate:(nullable id <MLN_GCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq;

#pragma mark Configuration

- (nullable id <MLN_GCDAsyncUdpSocketDelegate>)delegate;
- (void)setDelegate:(nullable id <MLN_GCDAsyncUdpSocketDelegate>)delegate;
- (void)synchronouslySetDelegate:(nullable id <MLN_GCDAsyncUdpSocketDelegate>)delegate;
...
- (void)getDelegate:(id <MLN_GCDAsyncUdpSocketDelegate> __nullable * __nullable)delegatePtr delegateQueue:(dispatch_queue_t __nullable * __nullable)delegateQueuePtr;
- (void)setDelegate:(nullable id <MLN_GCDAsyncUdpSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegate:(nullable id <MLN_GCDAsyncUdpSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;

/**
 * By default, both IPv4 and IPv6 are enabled.
 * 
 * This means MLN_GCDAsyncUdpSocket automatically supports both protocols,
 * and can send to IPv4 or IPv6 addresses,
 * as well as receive over IPv4 and IPv6.
 * 
 * For operations that require DNS resolution, MLN_GCDAsyncUdpSocket supports both IPv4 and IPv6.
 * If a DNS lookup returns only IPv4 results, MLN_GCDAsyncUdpSocket will automatically use IPv4.
 * If a DNS lookup returns only IPv6 results, MLN_GCDAsyncUdpSocket will automatically use IPv6.
 ...
 * This is due to the fact that MLN_GCDAsyncUdpSocket does NOT copy the data.
 ...
 *    or the system tools to handle this aren't available (e.g. on a mobile device).
 * 
 * For more information about MLN_GCDAsyncUdpSocketSendFilterBlock, see the documentation for its typedef.
...
**/
- (void)setSendFilter:(nullable MLN_GCDAsyncUdpSocketSendFilterBlock)filterBlock withQueue:(nullable dispatch_queue_t)filterQueue;
...
**/
- (void)setSendFilter:(nullable MLN_GCDAsyncUdpSocketSendFilterBlock)filterBlock
 ...
 * 
 * Important Note:
 * MLN_GCDAsyncUdpSocket may be running in parallel with your code.
 * That is, your delegate is likely running on a separate thread/dispatch_queue.
 * When you invoke this method, MLN_GCDAsyncUdpSocket may have already dispatched delegate methods to be invoked.
 ...
 * [udpSocket setReceiveFilter:filter withQueue:myParsingQueue];
 * 
 * For more information about MLN_GCDAsyncUdpSocketReceiveFilterBlock, see the documentation for its typedef.
 * To remove a previously set filter, invoke this method and pass a nil filterBlock and NULL filterQueue.
 * 
 * Note: This method invokes setReceiveFilter:withQueue:isAsynchronous: (documented below),
 *       passing YES for the isAsynchronous parameter.
**/
- (void)setReceiveFilter:(nullable MLN_GCDAsyncUdpSocketReceiveFilterBlock)filterBlock withQueue:(nullable dispatch_queue_t)filterQueue;
 ...
 * For example, you can't query properties on the socket.
**/
- (void)setReceiveFilter:(nullable MLN_GCDAsyncUdpSocketReceiveFilterBlock)filterBlock
               withQueue:(nullable dispatch_queue_t)filterQueue
          isAsynchronous:(BOOL)isAsynchronous;
 ...
 * 
 * The MLN_GCDAsyncUdpSocket instance may optionally be used again.
 ...
 * 
 * Generally MLN_GCDAsyncUdpSocket doesn't use CFStream. (It uses the faster GCD API's.)
