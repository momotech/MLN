...
Pod::Spec.new do |s|
    ...
    s.author           = 'MoMo'
    s.source           = { :git => 'https://github.com/wemomo/MLN.git', :tag => s.version.to_s }
    ...
    s.subspec 'Protobuf' do |pb|
      pb.name = 'Protobuf'
      pb.source_files = 'MLNDevTool/Classes/Protobuf/**/*.{h,m,c}'
      pb.public_header_files = 'MLNDevTool/Classes/Protobuf/**/*.h'
