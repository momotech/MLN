 ...
 */
public class GridLayoutItemDecorationFix extends RecyclerView.ItemDecoration {

    private static final String TAG = GridLayoutItemDecorationFix.class.getSimpleName();

    public int horizontalSpace;
    public int verticalSpace;


    UDCollectionViewGridLayoutFix mUDCollectionGridLayout;
    ...
    public GridLayoutItemDecorationFix(int orientation, UDCollectionViewGridLayoutFix udCollectionGridLayout) {
