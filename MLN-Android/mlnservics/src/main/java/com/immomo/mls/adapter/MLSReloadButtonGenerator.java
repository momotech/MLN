 ...
 */
public class MLSReloadButtonGenerator implements View.OnClickListener {
    protected ViewGroup container;
    protected MLSInstance instance;
    ...
    public MLSReloadButtonGenerator(ViewGroup container, MLSInstance instance) {
