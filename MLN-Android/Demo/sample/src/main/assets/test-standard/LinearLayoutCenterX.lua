...
centerX2 = Label()
centerX2:textColor(Color(0x73, 0x00, 0x00, 1)):fontSize(20):marginTop(20)
centerX2:text('点击 获取 centerX 数值')
...
centerX3 = Label()
centerX3:textColor(Color(0x73, 0x00, 0x00, 1)):fontSize(20):marginTop(20)
centerX3:text('点击 获取 centerX 数值')
