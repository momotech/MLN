 ...
 * 注册方法：
 * new MLSBuilder.SIHolder(SingleInstanceDemo.LUA_CLASS_NAME, SingleInstanceDemo.class)
 */
@LuaClass
public class SingleInstanceDemo {
     ...
     */
    public SingleInstanceDemo(@NonNull Globals g, @NonNull LuaValue[] init) {
     ...
     * @param g 虚拟机
     */
    //public SingleInstanceDemo(@NonNull Globals g) {}

    /**
     * Lua构造函数，不需要虚拟机及上下文环境
     * @param init 初始化参数
     */
    //public SingleInstanceDemo(@NonNull LuaValue[] init) {}

    /**
     * Lua构造函数，不需要虚拟机，不关心初始化参数
     */
    //public SingleInstanceDemo() {}
    //</editor-fold>
