...
#endif
#define LUA_CLASS_NAME "ImageButton"
...
#define JNIMETHODDEFILE(s) Java_com_immomo_mmui_ud_UDImageButton_ ## s
/**
...
JNIEXPORT void JNICALL JNIMETHODDEFILE(_1init)
    ...
    setImageID = (*env)->GetMethodID(env, clz, "setImage", "(Ljava/lang/String;Ljava/lang/String;)V");
}
/**
 * java层需要将此ud注册到虚拟机里
 * @param l 虚拟机
...
/**
 * void setImage(java.lang.String,java.lang.String)
 */
static int _setImage(lua_State *L) {
#ifdef STATISTIC_PERFORMANCE
    ...
    (*env)->CallVoidMethod(env, jobj, setImageID, p1, p2);
