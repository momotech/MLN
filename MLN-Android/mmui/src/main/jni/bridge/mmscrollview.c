...
static jmethodID contentSizeID;
...
JNIEXPORT void JNICALL JNIMETHODDEFILE(_1init)
    ...
    getContentOffsetID = (*env)->GetMethodID(env, clz, "getContentOffset", "()Lcom/immomo/mmui/ud/UDPoint;");
    setContentOffsetID = (*env)->GetMethodID(env, clz, "setContentOffset", "(Lcom/immomo/mmui/ud/UDPoint;)V");
    ...
    contentSizeID = (*env)->GetMethodID(env, clz, "contentSize", "()Lcom/immomo/mmui/ud/UDSize;");
    ...
    setOffsetWithAnimID = (*env)->GetMethodID(env, clz, "setOffsetWithAnim", "(Lcom/immomo/mmui/ud/UDPoint;)V");
...
/**
 * com.immomo.mmui.ud.UDPoint getContentOffset()
 * void setContentOffset(com.immomo.mmui.ud.UDPoint)
 */
static int _contentOffset(lua_State *L) {
#ifdef STATISTIC_PERFORMANCE
...
/**
 * com.immomo.mmui.ud.UDSize contentSize()
 */
static int _contentSize(lua_State *L) {
#ifdef STATISTIC_PERFORMANCE
    struct timeval start = {0};
...
#endif
    PRE
    jobject ret = (*env)->CallObjectMethod(env, jobj, contentSizeID);
    if (catchJavaException(env, L, LUA_CLASS_NAME ".contentSize")) {
        FREE(env, jobj);
        return lua_error(L);
    }
    FREE(env, jobj);
...
#ifdef STATISTIC_PERFORMANCE
    gettimeofday(&end, NULL);
    userdataMethodCall(ud->name + strlen(METATABLE_PREFIX), "contentSize", _get_milli_second(&end) - _get_milli_second(&start));
#endif
    return 1;
}
/**
...
/**
 * void setOffsetWithAnim(com.immomo.mmui.ud.UDPoint)
 */
static int _setOffsetWithAnim(lua_State *L) {
#ifdef STATISTIC_PERFORMANCE
    struct timeval start = {0};
