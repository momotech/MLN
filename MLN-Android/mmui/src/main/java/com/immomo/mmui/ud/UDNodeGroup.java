...
public class UDNodeGroup<V extends VirtualLayout & ILViewGroup> extends UDView<V> implements IYogaGroup {
    ...
    public void insertView(UDView view, int index) {
        ...
        if (layoutParams != null) {
            v.addView(VirtualViewUtil.removeFromParent(sub, view.getFlexNode()), index, layoutParams, view.getFlexNode());
        } else {
            v.addView(VirtualViewUtil.removeFromParent(sub, view.getFlexNode()), index, view.getFlexNode());
        }
    }
    //</editor-fold>
