...
public class UDAnimation extends UDBaseAnimation {
    ...
    public void timing(int timing, LuaTable table) {
        if (timing == Timing.Spring) {
            ...
            if (javaUserdata instanceof SpringAnimation) {
                springAnimation = (SpringAnimation) javaUserdata;
            } else {
                if (javaUserdata != null)
                    javaUserdata.release();
                springAnimation = new SpringAnimation(target.getView(), property);
            }
            if (table != null) {
            ...
            final ObjectAnimation objectAnimation;
            if (javaUserdata instanceof ObjectAnimation) {
                objectAnimation = (ObjectAnimation) javaUserdata;
            } else {
                if (javaUserdata != null)
                    javaUserdata.release();
                objectAnimation = new ObjectAnimation(target.getView(), property);
            }
