...
@DoNotStrip
public abstract class YogaNodeJNIBase extends FlexNode implements Cloneable {
  ...
  public YogaNodeJNIBase getChildAt(int i) {
    if (mChildren == null) {
      throw new IllegalStateException("FlexNode does not have children");
    }
    return mChildren.get(i);
  }

  public void addChildAt(FlexNode c, int i) {
  ...
  public void swapChildAt(FlexNode newChild, int position) {
  ...
  public YogaNodeJNIBase removeChildAt(int i) {
    if (mChildren == null) {
      throw new IllegalStateException(
          "Trying to remove a child of a FlexNode that does not have children");
    }
  ...
  /**
   * The owner is used to identify the YogaTree that a {@link FlexNode} belongs to. This method will
   * return the parent of the {@link FlexNode} when the {@link FlexNode} only belongs to one
   * YogaTree or null when the {@link FlexNode} is shared between two or more YogaTrees.
   *
   * @return the {@link FlexNode} that owns this {@link FlexNode}.
   */
  @Nullable
  ...
  @Override
  public void copyStyle(FlexNode srcNode) {
   ...
   *
   * @return the nativePointer of the newNode {@link FlexNode}
   */
  @DoNotStrip
  private final long replaceChild(YogaNodeJNIBase newNode, int childIndex) {
    if (mChildren == null) {
      throw new IllegalStateException("Cannot replace child. FlexNode does not have children");
    }
