...
void MLACGColorGetRGBAComponents(CGColorRef color, CGFloat components[])
{
  if (color) {
...
CGColorRef MLACGColorRGBACreate(const CGFloat components[])
{
#if TARGET_OS_IPHONE
...
CGColorRef MLACGColorWithColor(id color)
{
...
void MLAUIColorGetRGBAComponents(UIColor *color, CGFloat components[])
{
  return MLACGColorGetRGBAComponents(MLACGColorWithColor(color), components);
}

UIColor *MLAUIColorRGBACreate(const CGFloat components[])
{
  CGColorRef colorRef = MLACGColorRGBACreate(components);
...
void MLANSColorGetRGBAComponents(NSColor *color, CGFloat components[])
{
  return MLACGColorGetRGBAComponents(MLACGColorWithColor(color), components);
}

NSColor *MLANSColorRGBACreate(const CGFloat components[])
{
  CGColorRef colorRef = MLACGColorRGBACreate(components);
  NSColor *color = nil;
