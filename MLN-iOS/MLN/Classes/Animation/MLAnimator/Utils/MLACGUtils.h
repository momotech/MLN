 ...
 */
extern void MLACGColorGetRGBAComponents(CGColorRef color, CGFloat components[]);

/**
 Takes RGBA components and returns a CGColorRef.
 */
extern CGColorRef MLACGColorRGBACreate(const CGFloat components[]) CF_RETURNS_RETAINED;

/**
 Takes a color reference and returns a CGColor.
 */
extern CGColorRef MLACGColorWithColor(id color) CF_RETURNS_NOT_RETAINED;
 ...
 */
extern void MLAUIColorGetRGBAComponents(UIColor *color, CGFloat components[]);

/**
 Takes RGBA components and returns a UIColor.
 */
extern UIColor *MLAUIColorRGBACreate(const CGFloat components[]) NS_RETURNS_RETAINED;
 ...
 */
extern void MLANSColorGetRGBAComponents(NSColor *color, CGFloat components[]);

/**
 Takes RGBA components and returns a NSColor.
 */
extern NSColor *MLANSColorRGBACreate(const CGFloat components[]) NS_RETURNS_RETAINED;
