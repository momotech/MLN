...
@interface MLNWaterfallLayoutFix ()
...
@implementation MLNWaterfallLayoutFix
...
LUA_EXPORT_BEGIN(MLNWaterfallLayoutFix)
LUA_EXPORT_PROPERTY(spanCount, "setColumnCount:", "columnCount", MLNWaterfallLayoutFix)
LUA_EXPORT_PROPERTY(lineSpacing, "setLineSpacing:","lineSpacing", MLNWaterfallLayoutFix)
LUA_EXPORT_PROPERTY(itemSpacing, "setItemSpacing:","itemSpacing", MLNWaterfallLayoutFix)
LUA_EXPORT_METHOD(layoutInset, "lua_setlayoutInset:left:bottom:right:", MLNWaterfallLayoutFix)
LUA_EXPORT_END(MLNWaterfallLayoutFix, WaterfallLayoutFix, NO, NULL, NULL)
