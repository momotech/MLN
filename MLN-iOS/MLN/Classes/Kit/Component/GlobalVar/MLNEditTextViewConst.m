...
LUA_EXPORT_GLOBAL_VAR(EditTextViewContentType, (@{@"UserName":@(MLNInternalTextAutoFillUserName),
                                                @"Password":@(MLNInternalTextAutoFillPassword)}))
...
LUA_EXPORT_GLOBAL_VAR_END(MLNEditTextViewConst)
