...
LUA_EXPORT_METHOD_WITH_CFUNC(add, luaui_array_addObject, NSMutableArray)
LUA_EXPORT_METHOD_WITH_CFUNC(addAll, luaui_array_addObjectsFromArray, NSMutableArray)
LUA_EXPORT_METHOD_WITH_CFUNC(remove, luaui_array_removeObjectAtIndex, NSMutableArray)
LUA_EXPORT_METHOD_WITH_CFUNC(removeObject, luaui_array_removeObject, NSMutableArray)
LUA_EXPORT_METHOD_WITH_CFUNC(removeObjects, luaui_array_removeObjects, NSMutableArray)
LUA_EXPORT_METHOD_WITH_CFUNC(removeObjectsAtRange, luaui_array_removeObjectsAtRange, NSMutableArray)
LUA_EXPORT_METHOD_WITH_CFUNC(removeAll, luaui_array_removeAllObjects, NSMutableArray)
LUA_EXPORT_METHOD_WITH_CFUNC(get, luaui_array_objectAtIndex, NSMutableArray)
LUA_EXPORT_METHOD_WITH_CFUNC(size, luaui_array_size, NSMutableArray)
LUA_EXPORT_METHOD_WITH_CFUNC(contains, luaui_array_contains, NSMutableArray)
LUA_EXPORT_METHOD_WITH_CFUNC(insert, luaui_array_insertObject, NSMutableArray)
LUA_EXPORT_METHOD_WITH_CFUNC(insertObjects, luaui_array_insertObjects, NSMutableArray)
LUA_EXPORT_METHOD_WITH_CFUNC(replace, luaui_array_replaceObject, NSMutableArray)
LUA_EXPORT_METHOD_WITH_CFUNC(replaceObjects, luaui_array_replaceObjects, NSMutableArray)
LUA_EXPORT_METHOD_WITH_CFUNC(exchange, luaui_array_exchange, NSMutableArray)
LUA_EXPORT_METHOD_WITH_CFUNC(subArray, luaui_array_sub, NSMutableArray)
LUA_EXPORT_METHOD_WITH_CFUNC(copyArray, luaui_array_copy, NSMutableArray)
LUA_EXPORT_END_WITH_CFUNC(NSMutableArray, Array, NO, NULL, luaui_newArray)
