...
LUAUI_EXPORT_BEGIN(MLNUIFrameAnimation)
LUAUI_EXPORT_METHOD(setTranslateXTo, "luaui_setTranslateXTo:", MLNUIFrameAnimation)
LUAUI_EXPORT_METHOD(setTranslateX, "luaui_setTranslateX:to:", MLNUIFrameAnimation)
LUAUI_EXPORT_METHOD(setTranslateYTo, "luaui_setTranslateYTo:", MLNUIFrameAnimation)
LUAUI_EXPORT_METHOD(setTranslateY, "luaui_setTranslateY:to:", MLNUIFrameAnimation)
LUAUI_EXPORT_METHOD(setScaleWidthTo, "luaui_setScaleWidthTo:", MLNUIFrameAnimation)
LUAUI_EXPORT_METHOD(setScaleWidth, "luaui_setScaleWidth:to:", MLNUIFrameAnimation)
LUAUI_EXPORT_METHOD(setScaleHeightTo, "luaui_setScaleHeightTo:", MLNUIFrameAnimation)
LUAUI_EXPORT_METHOD(setScaleHeight, "luaui_setScaleHeight:to:", MLNUIFrameAnimation)
LUAUI_EXPORT_METHOD(setAlphaTo, "luaui_setAlphaTo:", MLNUIFrameAnimation)
LUAUI_EXPORT_METHOD(setAlpha, "luaui_setAlpha:to:", MLNUIFrameAnimation)
LUAUI_EXPORT_METHOD(setBgColorTo, "luaui_setBgColorTo:", MLNUIFrameAnimation)
LUAUI_EXPORT_METHOD(setBgColor, "luaui_setBgColor:to:", MLNUIFrameAnimation)
LUAUI_EXPORT_METHOD(setDuration, "setDuration:", MLNUIFrameAnimation)
LUAUI_EXPORT_METHOD(setDelay, "setDelay:", MLNUIFrameAnimation)
LUAUI_EXPORT_METHOD(repeatCount, "luaui_repeatCount:", MLNUIFrameAnimation)
LUAUI_EXPORT_METHOD(needRepeat, "luaui_needRepeat", MLNUIFrameAnimation)
LUAUI_EXPORT_METHOD(needAutoreverseRepeat, "luaui_needAutoreverseRepeat", MLNUIFrameAnimation)
LUAUI_EXPORT_METHOD(setInterpolator, "luaui_setInterpolator:", MLNUIFrameAnimation)
LUAUI_EXPORT_METHOD(start, "luaui_startWithView:", MLNUIFrameAnimation)
LUAUI_EXPORT_METHOD(setEndCallback, "setCompletionCallback:", MLNUIFrameAnimation)
LUAUI_EXPORT_END(MLNUIFrameAnimation, FrameAnimation, NO, NULL, NULL)
