...
LUA_EXPORT_VIEW_PROPERTY(layout, "luaui_setCollectionViewLayout:","luaui_collectionViewLayout", MLNUICollectionView)
LUA_EXPORT_VIEW_PROPERTY(openReuseCell, "setLuaui_openReuseCell:","luaui_openReuseCell", MLNUICollectionView)
LUA_EXPORT_VIEW_PROPERTY(scrollDirection, "luaui_setScrollDirection:","luaui_scrollDirection", MLNUICollectionView)
LUA_EXPORT_VIEW_PROPERTY(showScrollIndicator, "luaui_showScrollIndicator:","luaui_isShowScrollIndicator", MLNUICollectionView)
LUA_EXPORT_VIEW_PROPERTY(showsHorizontalScrollIndicator, "luaui_setShowsHorizontalScrollIndicator:", "luaui_showsHorizontalScrollIndicator", MLNUICollectionView)
LUA_EXPORT_VIEW_PROPERTY(showsVerticalScrollIndicator, "luaui_setShowsVerticalScrollIndicator:", "luaui_showsVerticalScrollIndicator", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(reloadData, "luaui_reloadData", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(reloadAtRow, "luaui_reloadAtRow:section:animation:", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(reloadAtSection, "luaui_reloadAtSection:animation:", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(scrollToCell, "luaui_scrollToCell:section:animation:", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(scrollToTop, "luaui_scrollToTop:", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(isStartPosition, "luaui_scrollIsTop", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(deleteCellAtRow, "luaui_deleteAtRow:section:", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(insertCellAtRow, "luaui_insertAtRow:section:", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(insertCellsAtSection, "luaui_insertCellsAtSection:startRow:endRow:", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(deleteCellsAtSection, "luaui_deleteCellsAtSection:startRow:endRow:", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(pointAtIndexPath, "luaui_pointAtIndexPath:section:", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(deleteRow, "luaui_deleteRow:section:animated:", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(insertRow, "luaui_insertRow:section:animated:", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(insertRowsAtSection, "luaui_insertRowsAtSection:startRow:endRow:animated:", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(deleteRowsAtSection, "luaui_deleteRowsAtSection:startRow:endRow:animated:", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(cellWithSectionRow, "luaui_cellAt:row:", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(visibleCells, "luaui_visibleCells", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(setScrollEnable, "mlnui_setLuaScrollEnable:", MLNUICollectionView)
// refresh header
LUA_EXPORT_VIEW_PROPERTY(refreshEnable, "setLuaui_refreshEnable:", "luaui_refreshEnable", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(isRefreshing, "luaui_isRefreshing", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(startRefreshing, "luaui_startRefreshing", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(stopRefreshing, "luaui_stopRefreshing", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(setRefreshingCallback, "setLuaui_refreshCallback:", MLNUICollectionView)
// load footer
LUA_EXPORT_VIEW_PROPERTY(loadEnable, "setLuaui_loadEnable:", "luaui_loadEnable", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(isLoading, "luaui_isLoading", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(stopLoading, "luaui_stopLoading", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(noMoreData, "luaui_noMoreData", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(resetLoading, "luaui_resetLoading", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(loadError, "luaui_loadError", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(setLoadingCallback, "setLuaui_loadCallback:", MLNUICollectionView)
// ScrollView callback
LUA_EXPORT_VIEW_METHOD(padding, "luaui_setPaddingWithTop:right:bottom:left:", MLNUICollectionView)
LUA_EXPORT_VIEW_PROPERTY(loadThreshold, "setLuaui_loadahead:", "luaui_loadahead", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(setScrollBeginCallback, "setLuaui_scrollBeginCallback:", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(setScrollingCallback, "setLuaui_scrollingCallback:", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(setEndDraggingCallback, "setLuaui_endDraggingCallback:", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(setStartDeceleratingCallback, "setLuaui_startDeceleratingCallback:",MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(setScrollEndCallback, "setLuaui_scrollEndCallback:",MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(setContentInset, "luaui_setContentInset:right:bottom:left:", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(getContentInset, "luaui_getContetnInset:", MLNUICollectionView)
// deprected method
LUA_EXPORT_VIEW_PROPERTY(contentSize, "luaui_setContentSize:", "luaui_contentSize", MLNUICollectionView)
LUA_EXPORT_VIEW_PROPERTY(scrollEnabled, "luaui_setScrollEnabled:", "luaui_scrollEnabled", MLNUICollectionView)
// private method
LUA_EXPORT_VIEW_PROPERTY(contentOffset, "luaui_setContentOffset:", "luaui_contentOffset", MLNUICollectionView)
LUA_EXPORT_VIEW_PROPERTY(i_bounces, "luaui_setBounces:", "luaui_bounces", MLNUICollectionView)
LUA_EXPORT_VIEW_PROPERTY(i_bounceHorizontal, "luaui_setAlwaysBounceHorizontal:", "luaui_alwaysBounceHorizontal", MLNUICollectionView)
LUA_EXPORT_VIEW_PROPERTY(i_bounceVertical, "luaui_setAlwaysBounceVertical:", "luaui_alwaysBounceVertical", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(setScrollIndicatorInset, "luaui_setScrollIndicatorInset:right:bottom:left:", MLNUICollectionView)
LUA_EXPORT_VIEW_METHOD(setOffsetWithAnim, "luaui_setContentOffsetWithAnimation:", MLNUICollectionView)
LUA_EXPORT_VIEW_END(MLNUICollectionView, CollectionView, YES, "MLNUIView", "initWithMLNUILuaCore:refreshEnable:loadEnable:")
