...
LUA_EXPORT_METHOD(reset, "luaui_reset", MLNUICanvasPath)
LUA_EXPORT_METHOD(moveTo, "luaui_moveTo:toY:", MLNUICanvasPath)
LUA_EXPORT_METHOD(lineTo, "luaui_lineTo:toY:", MLNUICanvasPath)
LUA_EXPORT_METHOD(quadTo, "luaui_quadTo:endY:controlX:controlY:", MLNUICanvasPath)
LUA_EXPORT_METHOD(cubicTo, "luaui_cubicTo:endY:controlX1:controlY1:controlX2:controlY2:", MLNUICanvasPath)
LUA_EXPORT_METHOD(arcTo, "luaui_addArcWith:centerY:radius:startAngle:endAngle:", MLNUICanvasPath)
LUA_EXPORT_METHOD(addArc, "luaui_addArcWith:centerY:radius:startAngle:endAngle:clockwise:", MLNUICanvasPath)
LUA_EXPORT_METHOD(addPath, "luaui_addPath:", MLNUICanvasPath)
LUA_EXPORT_METHOD(addRect, "luaui_addRect:top:right:bottom:clockwise:", MLNUICanvasPath)
LUA_EXPORT_METHOD(addCircle, "luaui_addCircle:y:radius:clockwise:", MLNUICanvasPath)
LUA_EXPORT_METHOD(lineWidth, "luaui_lineWidth:", MLNUICanvasPath)
LUA_EXPORT_METHOD(stroke, "luaui_stroke", MLNUICanvasPath)
LUA_EXPORT_METHOD(close, "luaui_closePath", MLNUICanvasPath)
LUA_EXPORT_METHOD(setFillType, "luaui_setFillType:", MLNUICanvasPath)
