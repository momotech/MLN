...
LUAUI_EXPORT_VIEW_PROPERTY(paddingPercentTop, "setLuaui_paddingPercentTop:","luaui_paddingPercentTop", MLNUIView)
LUAUI_EXPORT_VIEW_PROPERTY(paddingPercentLeft, "setLuaui_paddingPercentLeft:","luaui_paddingPercentLeft", MLNUIView)
LUAUI_EXPORT_VIEW_PROPERTY(paddingPercentBottom, "setLuaui_paddingPercentBottom:","luaui_paddingPercentBottom", MLNUIView)
LUAUI_EXPORT_VIEW_PROPERTY(paddingPercentRight, "setLuaui_paddingPercentRight:","luaui_paddingPercentRight", MLNUIView)
...
LUAUI_EXPORT_VIEW_PROPERTY(marginPercentTop, "setLuaui_marginPercentTop:","luaui_marginPercentTop", MLNUIView)
LUAUI_EXPORT_VIEW_PROPERTY(marginPercentLeft, "setLuaui_marginPercentLeft:","luaui_marginPercentLeft", MLNUIView)
LUAUI_EXPORT_VIEW_PROPERTY(marginPercentBottom, "setLuaui_marginPercentBottom:","luaui_marginPercentBottom", MLNUIView)
LUAUI_EXPORT_VIEW_PROPERTY(marginPercentRight, "setLuaui_marginPercentRight:","luaui_marginPercentRight", MLNUIView)
...
LUAUI_EXPORT_VIEW_PROPERTY(positionPercentTop, "setLuaui_positionPercentTop:","luaui_positionPercentTop", MLNUIView)
LUAUI_EXPORT_VIEW_PROPERTY(positionPercentLeft, "setLuaui_positionPercentLeft:","luaui_positionPercentLeft", MLNUIView)
LUAUI_EXPORT_VIEW_PROPERTY(positionPercentBottom, "setLuaui_positionPercentBottom:","luaui_positionPercentBottom", MLNUIView)
LUAUI_EXPORT_VIEW_PROPERTY(positionPercentRight, "setLuaui_positionPercentRight:","luaui_positionPercentRight", MLNUIView)
