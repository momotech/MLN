...
LUAUI_EXPORT_BEGIN(MLNUICanvasAnimation)
LUAUI_EXPORT_PROPERTY(setPivotXType, "setPivotXType:", "pivotXType", MLNUICanvasAnimation)
LUAUI_EXPORT_PROPERTY(setPivotX, "setPivotX:", "luaui_pivotX", MLNUICanvasAnimation)
LUAUI_EXPORT_PROPERTY(setPivotYType, "setPivotYType:", "pivotYType", MLNUICanvasAnimation)
LUAUI_EXPORT_PROPERTY(setPivotY, "setPivotY:", "luaui_pivotY", MLNUICanvasAnimation)
LUAUI_EXPORT_PROPERTY(setDuration, "setDuration:", "duration", MLNUICanvasAnimation)
LUAUI_EXPORT_PROPERTY(setDelay, "setDelay:", "delay", MLNUICanvasAnimation)
LUAUI_EXPORT_PROPERTY(setInterpolator, "setInterpolator:", "interpolator", MLNUICanvasAnimation)
LUAUI_EXPORT_METHOD(setRepeat, "luaui_setRepeat:count:",  MLNUICanvasAnimation)
LUAUI_EXPORT_METHOD(startWithView, "luaui_startWithView:", MLNUICanvasAnimation)
LUAUI_EXPORT_METHOD(cancel, "cancel", MLNUICanvasAnimation)
LUAUI_EXPORT_METHOD(pause, "luaui_pause", MLNUICanvasAnimation)
LUAUI_EXPORT_METHOD(resume, "luaui_resumeAnimations", MLNUICanvasAnimation)
LUAUI_EXPORT_METHOD(stop, "luaui_stop", MLNUICanvasAnimation)
LUAUI_EXPORT_METHOD(setStartCallback, "luaui_setStartCallback:", MLNUICanvasAnimation)
LUAUI_EXPORT_METHOD(setEndCallback, "luaui_setEndCallback:", MLNUICanvasAnimation)
LUAUI_EXPORT_METHOD(setRepeatCallback, "luaui_setRepeatCallback:", MLNUICanvasAnimation)
LUAUI_EXPORT_METHOD(clone, "luaui_clone", MLNUICanvasAnimation)
LUAUI_EXPORT_METHOD(setAutoBack, "luaui_setAutoBack:", MLNUICanvasAnimation)
LUAUI_EXPORT_END(MLNUICanvasAnimation, CanvasAnimation, NO, NULL, NULL)
