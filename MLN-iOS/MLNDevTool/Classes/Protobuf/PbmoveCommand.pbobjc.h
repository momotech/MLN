 ...
 **/
@interface PbmoveCommandRoot : GPBRootObject
@end

#pragma mark - pbmovecommand

typedef GPB_ENUM(pbmovecommand_FieldNumber) {
  pbmovecommand_FieldNumber_Basecommand = 1,
  pbmovecommand_FieldNumber_OldFilePath = 2,
  pbmovecommand_FieldNumber_OldRelativeFilePath = 3,
  pbmovecommand_FieldNumber_NewFilePath = 4,
  pbmovecommand_FieldNumber_NewRelativeFilePath = 5,
};

@interface pbmovecommand : GPBMessage
