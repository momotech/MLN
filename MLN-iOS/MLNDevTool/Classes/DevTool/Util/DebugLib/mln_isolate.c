...
extern lua_State *mln_create_vm_in_subthread(void);
extern void mln_set_vm_bundle_path(lua_State *PL, lua_State *L);
extern void mln_release_vm_in_subthread(lua_State *L);
...
#define new_lvm(L) mln_create_vm_in_subthread()
...
static int post_action(lua_State *L) {
    ...
    mln_set_vm_bundle_path(L, child->L);
...
void* mln_thread_sync_to_main(lua_State *L, void*(*callback)(void *)) {
    ...
    void *retvalue = *(void **)(ctx->retbuffer);
    free(ctx);
    return retvalue;
#endif
}
