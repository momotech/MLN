...
@interface MLNNativeViewPager() <UICollectionViewDelegate, MLNNativeTabSegmentScrollHandlerDelegate>
...
@property (nonatomic, strong) MLNNativeTabSegmentScrollHandler *viewPagerScrollHandler;

@property (nonatomic, strong) MLNBeforeWaitingTask *lazyTask;
@property (nonatomic, assign) NSInteger scrollToIndex;
@end

@implementation MLNNativeViewPager
...
#pragma mark - setter
- (void)setAdapter:(id<UICollectionViewDataSource, MLNNativeCycleScrollViewDelegate>)adapter
{
//    MLNCheckTypeAndNilValue(adapter, @"ViewPagerAdapter", [MLNNativeViewPagerAdapter class])
    if (_adapter != adapter) {
        _adapter = adapter;
        _mainView.dataSource = adapter;
...
#pragma mark - MLNNativeTabSegmentViewDelegate
...
#pragma mark - MLNNativeTabSegmentScrollHandlerDelegate
...
- (void)lua_setTabScrollingListener:(MLNBlock *)block
{
    ...
    if (!_viewPagerScrollHandler && block) {
        _viewPagerScrollHandler = [[MLNNativeTabSegmentScrollHandler alloc] init];
...
//LUA_EXPORT_VIEW_BEGIN(MLNNativeViewPager)
//LUA_EXPORT_VIEW_PROPERTY(adapter, "setAdapter:","adapter", MLNNativeViewPager)
//LUA_EXPORT_VIEW_PROPERTY(autoScroll, "setAutoScroll:", "autoScroll", MLNNativeViewPager)
//LUA_EXPORT_VIEW_PROPERTY(recurrence, "setRecurrence:", "recurrence", MLNNativeViewPager)
//LUA_EXPORT_VIEW_PROPERTY(frameInterval, "setFrameInterval:", "frameInterval", MLNNativeViewPager)
//LUA_EXPORT_VIEW_PROPERTY(showIndicator, "setShowPageControl:", "showPageControl", MLNNativeViewPager)
//LUA_EXPORT_VIEW_PROPERTY(aheadLoad, "setAheadLoad:", "aheadLoad", MLNNativeViewPager)
//LUA_EXPORT_METHOD(endDragging, "setDidEndDeceleratingBlock:", MLNNativeViewPager)
//LUA_EXPORT_METHOD(reloadData, "lua_reloadData", MLNNativeViewPager)
//LUA_EXPORT_METHOD(reloadDataFinished, "lua_reloadFinished:", MLNNativeViewPager)
//LUA_EXPORT_METHOD(scrollToPage, "lua_scrollToPage:aniamted:", MLNNativeViewPager)
//LUA_EXPORT_METHOD(currentPageColor, "setCurrentPageDotColor:", MLNNativeViewPager)
//LUA_EXPORT_METHOD(pageDotColor, "setPageDotColor:", MLNNativeViewPager)
//LUA_EXPORT_METHOD(pageControlDotSize, "setPageControlDotSize:", MLNNativeViewPager)
//LUA_EXPORT_METHOD(currentPage, "lua_currentPage", MLNNativeViewPager)
//LUA_EXPORT_METHOD(setPreRenderCount, "lua_setPreRenderCount:", MLNNativeViewPager)
//LUA_EXPORT_METHOD(cellWillAppear, "lua_cellWillAppearCallback:", MLNNativeViewPager)
//LUA_EXPORT_METHOD(cellDidDisappear, "lua_cellDidDisappearCallback:", MLNNativeViewPager)
//LUA_EXPORT_METHOD(setPageClickListener, "lua_cellClickedCallback:", MLNNativeViewPager)
//LUA_EXPORT_METHOD(setScrollEnable, "lua_setLuaScrollEnable:", MLNNativeViewPager)
//LUA_EXPORT_METHOD(setTabScrollingListener, "lua_setTabScrollingListener:", MLNNativeViewPager)
//LUA_EXPORT_METHOD(padding, "lua_setPadding:right:bottom:left:", MLNNativeViewPager)
//LUA_EXPORT_METHOD(onChangeSelected, "lua_setPageSelectedListener:", MLNNativeViewPager)
//LUA_EXPORT_VIEW_END(MLNNativeViewPager, ViewPager, YES, "MLNView", NULL)
