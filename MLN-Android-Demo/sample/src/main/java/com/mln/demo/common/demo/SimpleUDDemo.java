 ...
 * 注册方法:
 * Register.newUDHolderWithLuaClass(Dialog.LUA_CLASS_NAME, SimpleUDDemo.class, true)
 * 若想在Java层实现参数自动转换，则增加注册:
 * @see com.immomo.mls.MLSBuilder#registerCovert
 * @see com.immomo.mls.MLSBuilder.CHolder
 * new MLSBuilder.CHolder(SimpleUDDemo.class)
 */
@LuaClass
public class SimpleUDDemo {
    /**
     * Lua类型，Lua可由此创建对象:
     ...
     */
    public SimpleUDDemo(@NonNull Globals g, @NonNull LuaValue[] init) {
     ...
     * @param g 虚拟机
     */
    //public SimpleUDDemo(@NonNull Globals g) {}

    /**
     * Lua构造函数，不需要虚拟机及上下文环境
     * @param init 初始化参数
     */
    //public SimpleUDDemo(@NonNull LuaValue[] init) {}
