 ...
 * 注册方法：
 * Register.newUDHolder(UDDemo。LUA_CLASS_NAME, UDDemo.class, true)
 */
@LuaApiUsed
public class UDDemo extends LuaUserdata<Object> {
    /**
     * Lua类名
     */
     ...
     */
    @LuaApiUsed
    protected UDDemo(long L, @NonNull LuaValue[] v) {
        super(L, v);
        /// 必须完成包裹对象的初始化
        javaUserdata = new Object();
    }
     ...
     */
    @LuaApiUsed
    public UDDemo(@NonNull Globals g, Object o) {
        super(g, o);
    }
    //</editor-fold>
...
//        return varargsOf(new UDDemo(getGlobals(), "other"));//返回一个userdata
     ...
     */
    /*public static final IJavaObjectGetter<UDDemo, Object> J = new IJavaObjectGetter<UDDemo, Object>() {
        @Override
        public Object getJavaObject(UDDemo lv) {
     ...
     * @see MLSBuilder.CHolder
     */
    /*public static final ILuaValueGetter<UDDemo, Object> L = new ILuaValueGetter<UDDemo, Object>() {
        @Override
        public UDDemo newInstance(Globals g, Object obj) {
            return new UDDemo(g, obj);
        }
    };*/
    //</editor-fold>
}
