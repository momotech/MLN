 ...
 * 注册方法：
 * Register.newUDHolder(UDViewDemo.LUA_CLASS_NAME, UDViewDemo.class, true, UDViewDemo.methods)
 */
@LuaApiUsed
public class UDViewDemo extends UDView<TextView> {
     ...
     */
    @LuaApiUsed
    protected UDViewDemo(long L, @NonNull LuaValue[] v) {
        super(L, v);
    }
     ...
     * @param o 初始化对象
     */
    public UDViewDemo(Globals g, @NonNull TextView o) {
        super(g, o);
    }
    ...
    @NonNull
    @Override
    protected TextView newView(@NonNull LuaValue[] init) {
