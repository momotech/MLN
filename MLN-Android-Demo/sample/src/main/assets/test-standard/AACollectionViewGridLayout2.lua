...
collectionView:width(MeasurementType.MATCH_PARENT)
collectionView:height(cHeight)
...
str = string.format("index = %d, begin = %d", indeex, begin)
print(str)
...
layout:itemSpacing(120)

layout:spanCount(spanCount)
layout:layoutInset(top, left, bottom, right)
...
adapter:initCell(function(cell)
    ...
    cell.label = Label()
    cell.label:frame(Rect(0, 0, MeasurementType.WRAP_CONTENT, MeasurementType.WRAP_CONTENT))
